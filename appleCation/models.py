...
class Apple(models.Model):
  ...
  OAstatus = models.CharField(max_length=20, choices=OAStatusChoices, default="None")
  ...
  OAthoughts = models.CharField(max_length=5, choices=OAThoughtsChoices, default="meh")
